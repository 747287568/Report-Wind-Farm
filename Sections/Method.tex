...
\label{sec:method}
	...
	(contiues on the intro)
	the optimalisation of rop 
	the realization of this optimailisation of power regulation is ... using ... 
	the optimalisation uses load and power data to determine the best turbine configuration, minimizing the loads. since true 
	ugh..
	a flowfield is created in floris(.....) (ref) 
	
	floris creates a 
	the optimalisation method is devided in 5 parts as shown in fig 1(ref), the rest of this section (behandeld) each of these sections, and highlights new reasearch done in this project.
	
	the first is the generation of farm wide wind data, this data is   
	these parts are visualised in figure 1(ref), the 'load pre-calculation' section  
