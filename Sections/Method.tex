...
lineair interpolation is used to estimate the DEL values between the data points of the LUT. It was assumed that the DELs as a result of the windspeed(U) could  be estimated accurately enough using only the 2 outer bounds. These bound were enough for the goal of this paper, though larger windfarms and different inflow wind velocities would require broadening these ranges. 
 
The DEL effect of the Dwake was also found to be accurate enough using fairly large stepsizes. the range of this parameter was chosen so alle downwind turbines within .. and .. meters could be accurately fitted. 
