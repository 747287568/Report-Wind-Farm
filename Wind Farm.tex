...
\renewcommand\thesubsubsection{\roman{subsection}.\roman{subsubsection}} % roman numerals for subsections
...
<<<<<<< HEAD
\fancyhead[C]{Wind Farm Control $\bullet$ May 2017 $\bullet$ Vol. XXI, No. 1} % Custom header text
=======
...
<<<<<<< HEAD
\title{Wind Farm Control\\\large Active Power Control and Minimizing Loads\\by Yaw Control and Axial Induction} % Article title
=======
